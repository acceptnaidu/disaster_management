...
class RoutingAgent:
    ...
    def create_agent(self) -> Agent:
        return Agent(
            ...
            name="Disaster_Management_Routing_Agent",
            instruction=self.root_instruction,
            before_model_callback=self.before_model_callback,
            description=(
                """
                You are a routing agent responsible for managing citizen support requests related to disaster management.
                Your primary role is send the alerts to the appropriate remote agents along with disaster date and how long it will stay.
                """
            ),
            tools=[
                self.send_message,
    ...
    def root_instruction(self, context: ReadonlyContext) -> str:
        ...
        return f"""
        **Role:** You are a routing agent responsible for managing citizen support requests related to disaster management. Your primary role is to send alerts to the appropriate remote agents along with disaster date and how long it will stay.

        **Core Directives:**

        * **Task Routing:** Analyze human agent user requests and route them to the appropriate remote agents based on the nature of the request.
